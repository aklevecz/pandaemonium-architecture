...
so!ware, in murder mysteries, and even in the animal kingdom. Although its
...
approach we can generalize and build into policies, so!ware, and action. This
...
uses. If you are a so!ware developer or designer, obfuscation you build into
your so!ware can keep user data safe—even from yourself, or from whoever
...
obfuscation is a lexicon of ways to put some sand in the gears, to buy time, and
...
that obfuscation has taken and demonstrate how these instances are cra!ed
...
2                                                                INTRODUCTION
about us are collected in circumstances we may not understand, for purposes
...
INTRODUCTION                                                                      3
attacks can be calculated with reference to such factors as key length, pro-
...
There are many obfuscation strategies. They are shaped by the user’s pur-
...
Hamburg, guiding searchlights and anti-aircra" guns in relation to a phosphor
...
8                                                                      CHAPTER 1
      If the designers of an obfuscation system have specific and detailed
...
metrical power relationships. It is a method, a"er all, that you have reason to
...
CORE CASES                                                                      9
scattered around the world to issue requests for the site in such volume that
...
tweets into coherent conversations on specific topics, and #ɬɪɢɭɦɮɚɥɶɧɚɹ
...
what is being discussed under that tag—the site’s Trending Topics list o"en
draws news coverage.9)


10                                                                   CHAPTER 1
      If you were following #ɬɪɢɭɦɮɚɥɶɧɚɹ, you would have seen tweet a"er
...
phrases. Eventually those tweets dominated the stream for #ɬɪɢɭɦɮɚɥɶɧɚɹ,
...
CORE CASES                                                                      11
suspiciously bot-like behavior, triggers systems within Twitter that identify
...
in the run-up to an election and during the period of unrest a"erward), they
...
utility, in which utility is o"en presented as detrimental to privacy, is evident
...
advance of potential requests—and an adversary is le" with many possible
...
Vincent Toubiana, exemplifies a so"ware strategy for concealing activity with
...
CORE CASES                                                                      13
queries. TrackMeNot submits queries in a manner that tries to mimic real
...
WikiLeaks system—includes a further refinement.20 A"er a statistical analysis
...
14                                                                  CHAPTER 1
megabytes, though a few outliers exceeded 700 megabytes. If an adversary
...
CORE CASES                                                                  15
     Many people assuming the same identity for group protection (for
...
16                                                                    CHAPTER 1
is one of a larger class of objects (cheap white busts of Napoleon) that are
...
all the time the robber needed.
      Then there is the powerful story, o"en retold though factually inaccurate,
...
CORE CASES                                                                    17
details,” in order to slow the production of intelligence for the Committee
...
traps them. Rather than trying to coordinate anti-aircra" guns to find a target
...
resents a superb example of operations security, tradecra", and managing a
secure network.
...
enormously time consuming and o"en prone to sloppiness, use of home
...
make encryption faster and more efficient. Based in London a"er his escape
...
22                                                                  CHAPTER 1
dial a London number, which would be picked up by an answering machine
...
was about to return to his homeland a"er working abroad for many years as a


CORE CASES                                                                   23
programmer for British telecommunications companies. Their agent would
...
legitimate requests. Shortly a#er receiving a fruitless order, or several of
...
Uber’s fake requests, which reduced the value of a job with Gett. (Ly#, a ride-
sharing company, has alleged that Uber has made similar obfuscation attacks
on its drivers.)
...
26                                                                    CHAPTER 2
      The idea for AdNauseam emerged out of a sense of helplessness: it isn’t
...
OTHER EXAMPLES                                                                  27
Unimportant information, in the form of quotes, is used to crowd the field of
...
loyalty cards were serving ends beyond the allotment of discounts. Soon a#er
...
30                                                                   CHAPTER 2
These written practices veer away from obfuscation per se into the more
...
OTHER EXAMPLES                                                                31
secretive movement, and of its vulnerabilities, than can be gained by other
...
32                                                                   CHAPTER 2
for “whilst.” “Deep” obfuscation runs the same system of classifiers used to
...
roso# sends out a patch to update Windows computers for security purposes;
...
34                                                                     CHAPTER 2
     Code obfuscation—a lively, rich area for the exploration of obfuscation in
...
gi# card or a debit card connected with a fixed account that gets refilled from
...
36                                                                    CHAPTER 2
interests and behaviors so typical that they even out the telling idiosyncrasies
of selfhood.)
     A#er performing some straightforward analysis, a clone can also take on a
...
could be yours, day a#er day. This fulfills the fundamental goal outlined by the
...
38                                                                    CHAPTER 2
experiment (which he called “Bayesian flooding,” a#er a form of statistical
...
OTHER EXAMPLES                                                               39
private, FaceCloak sends it to encrypted storage on a separate server, where it
...
space and the implications of facial-recognition so#ware.34 A#er considering




40                                                                      CHAPTER 2
the usual range of responses (wearing a mask, destroying cameras, ironic
...
OTHER EXAMPLES                                                              41
the situation remains, we do not want to speculate about exact decisions,
