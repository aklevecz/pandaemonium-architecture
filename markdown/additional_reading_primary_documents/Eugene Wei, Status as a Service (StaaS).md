...
# REMAINS of the DAY
Bespoke Observations • 80% fat free
...
Perhaps, if you've spent time around today's youth, you've watched with a mixture of horror and fascination as a teen snaps dozens of selfies before publishing the most

flattering one to Instagram, only to pull it down if it doesn't accumulate enough likes within the first hour. It’s another example of proof of work, or at least vigorous market research.
...
harmless status update Twitter was a less thirsty scene but also not much of a business. Still, sometimes I miss the halcyon days when not every tweet was a thirst trap. I hate the new Kanye, the bad mood Kanye, the always rude Kanye, spaz in the news Kanye, I miss the sweet Kanye, chop up the beats Kanye.
...
> **Figure text:** The rhetorical style of any Twitter account that continues to gain followers converges on that of a fortune cookie.
>
> — Eugene Wei (@eugenewei) May 21, 2018

As people start following more and more accounts on a social network, they reach a

point where the number of candidate stories exceeds their capacity to see them all. Even before that point, the sheer signal-to-noise ratio may decline to the point that it affects engagement. Almost any network that hits this inflection point turns to the same solution: an algorithmic feed.
...
Lastly, young people have a surplus of something which most adults always complain they have too little of: time. The hurdle rate on the time of the young is low, and so they can afford to spend some of that surplus exploring new social networks, mining them to see if the social capital returns are attractive, whereas most adults can afford to wait until a network has runaway product-market fit to jump in. The young respond to all the status games of the world with a consistent refrain: "If you are looking for
...
This bottom right quadrant is home to some businesses with over a billion users, but in minimizing social capital and competing purely on utility-derived network effects, this tends to be a brutally competitive battleground where even the slimmest moat is fought for with blood and sweat, especially in the digital world where useful features
...
into the world, we have lost the core of what made Snapchat the fastest way to communicate.
...
> samfbiddle 10
> Add Me on Snapchat!
> virginterminato is using Snapchat -
> Real-time picture chatting for iPhone.
> Share up to 10x faster than MMS!
...
> 
> Mutual BFs
> Appears next to someone who you share a Best
...
Amazon and Netflix both launched social efforts though they’ve largely been forgotten. It's likely the attempts were premature, pushed out into the world before either company had sufficient scale to enable positive flywheel effects. It’s hard
...
With social networks, one of the problems with seeing your own service through your users’ eyes is that every person has a different experience given who they follow and

what the service's algorithm feeds them. When you have hundreds of millions or even billions of users, across different cultures, how do you accurately monitor what's going on? Your metrics may tell you that engagement is high and growing, but what is the composition of that activity, and who is exposed to what parts?
...
That some of the largest, most valuable companies in history have been built so quickly in part on creating status games should be enough to convince you of the

existence and value of social capital. Since we live in the age of social media, we live in perhaps the peak of social capital assets in the history of civilization. However, as noted earlier, one of the challenges of studying it is that we don't have agreed-upon definitions of how to measure it and thus to track its flows.
...
ownership of it and store it safely. Almost all successful social networks are adept at providing both accumulation and storage mechanisms.
...
with your activity volume and serve as a source of continual short-term social capital injections, even if each like is, in the long-run, less valuable than a follower or a friend.
...
hashtag #fuckfuckjerry is an emergent protest against the popular Instagram account @fuckjerry which, like @fatjewish, curates the best jokes from others and daytraded that into a small media company, one that featured in the Fyre Festival debacle.
...
You can think of social capital accumulation incentives like these as ways to transform the potential energy of status into whatever form of kinetic energy your venture
...
📅 February 26, 2019
🏷️ tech, socialmedia, socialnetworks, facebook, snapchat, instagram, tiktok, amazon, apple
...
I quite enjoyed the ideas presented here, but, it seems to miss out on a critical element tied into social capital, which is sex, or more broadly, any form of oxyoctine-fueled semi taboo interaction.

There is a behavior pattern, it seems to me, where people try to build social capital up to a point where that gives them enough confidence to engage in some sort of "risky" social behavior in the real world. Or maybe to a point where the social capital even facilitates a context for that behavior.

In many cases the dynamic of social capital that facilitates real-life action seems to have a celling. Where once the behavior is facilitated, the existing social capital becomes useless and the need to accumulate more stops.

The obvious example here is something like teens engaged in a social status game on (X) where they perform and evaluated an identity. But the aim of the performed identity is just to find a boyfriend/girlfriend. Once that happens, they might suddenly stop caring about the status game, the "find a boyfriend" identity is now spent and might even be actively harmful.

This is not related to age, but rather to a finite goal for a given identity. Also, in many cases, the identity is not needed to begin with, it just acts as a confidence booster.

4 years ago · 0 Likes

I guess that makes alcohol & tobacco ( esp. of the expensive kind) pre-internet era's status-services, as they advertised one's status ( via price + brand ), carried a certain sense of Utility ( euphoria/ sedative quality) and entertainment feel around the experience... And the ability to buy that rare bottle would suffice as 'proof of work'

4 years ago · 0 Likes

I think reading this has convinced me to stop trying for likes on twitter since it's too well established, hah. Well, off to twitch to see if I can be a in my 30s streamer.
...
In case anyone's confused, this use of the term *social capital*, more or less synonymous with status, is different from the usage in sociology popularised by Robert Putnam in *Making Democracy Work* and *Bowling Alone*. That is about a society or group rather than the individual, describes the degree of reciprocity and connectedness within the society. And it's mostly positive, especially the bridging social capital between groups. (But bonding social capital can be negative for society if within, say, a criminal organisation.)
...
Which isn't to say that Mastodon is in itself immune to social capital, but rather, that an emphasis on utility is to be expected or even necessary, if a network is to survive. Of course, there's the advantage that Mastodon's

network is actually a network of networks similar to email, and so Mastodon's success or failure is instead bound to how well it allows its users to access that existing network.
...
Wow. Brilliant overview. Plenty to think about. I’m most interested in the older demographic and possibilities around those in their 30s, 40s looking to leverage social as a way to tap into talents they never had the opportunity to explore.

Special thank you to https://beta.cent.co/@matthew for giving this piece the attention it deserves.

5 years ago · 0 Likes

Hi I'm an engineer from china and working on a large social network & news feed product. I really love this article and it brings me a lot of ideas. I wonder could I translate it into chinese and post it in my WeChat Official Account? I will write it clearly it's from you.

5 years ago · 0 Likes

Interesting article. I think it could be more careful to distinguish between social status, social capital, public attention/fame/prominence/celebrity, and social recognition or praise.
...
Minor note: I believe "egoboo" long predates Amazon; I remember it being part of the Science Fiction Con milieu back into the early or mid-80's. In fact, wikipedia says it goes back to 1947 in the SF community: https://en.wikipedia.org/wiki/Egoboo

5 years ago · 0 Likes

There is a lot of really good arguments in this post. I'll definitely share that with my team, working on social aspects of our apps.

Thanks a lot!

5 years ago · 0 Likes

I'm undoubtedly not one of the first 8 people to comment, but I just wanted to say that this piece is brilliant!
...
Brilliant analytical piece. I'm a bit surprised, though, that you didn't mention Tara Hunt's book "The Whuffie Factor" (from way back in 2009). I always thought "whuffie" was a good name for this type of social capital.

5 years ago · 0 Likes

Hi Eugene! Was looking forward to listening to this long read with Pocket's voice feature but the majority of the post is lost and compressed to only two minutes when saved. Any idea why? Invisible asymptotes post works great.
...
Like a college le el credit in the (real) dynamics of social media. Headed back to a second full read.

If you don't mind, say more about how your thesis plays out in the activity of the 90+% lurkers who consume and follow but don't otherwise participate in the status arms race. I have some thoughts from the psychology of religion but would like to hear more from your thesis perspective.

**Daniel Pate** 5 years ago · 0 Likes

What are your thoughts on possible paths for those who index very low on the pursuit of status? In a time where StaaS is becoming relatively more valuable, what do you suggest for those who engage relatively little in status games, whether due to lack of desire or lack of ability? Yes, "weird kids" groups do arise but I wonder how different a group of outliers is from being a single outlier, in the tribal marketplace at large. The social capital in that instance seems to not transfer well, relative to group transfers that are closer to the center of the circle. "Esoteric" likely has a different curve and currency exchange rate than "Familiar", no?

5 years ago · 0 Likes

I finally finished reading it. Must admit I have the same distaste for status games you claim engineers tend to have.

More accurately as you pointed out, it just that I am badly skilled at these games or I prefer the status games in different (nerdier) domains.

Not sure what u recommend for an engineer type like do to “up my game” Join Instagram? 😄
...
such engaging proof of work! Status games are even more tribe specific than you highlight. The teenage brain is highly attuned to peer approval. Middle-aged adults don't play the same game because they can't win but because they have broader needs.

Perhaps the analogy could also be loosely extended to Proof of Stake. By vociferously pushing a point of view on social media, we validate our membership of the tribe. No matter if there are logical inconsistencies across diverse policy issues! Fortunately, if we get disheartened, then we can always pursue fragmentation by ICO'ing our own social variant.

5 years ago · 0 Likes

Thanks for the brilliant article- thought I finished reading it first on gmail, only to find that gmail truncated it because of the length!
