...
* This is an exact correlate of a communications system wherein given a received
   ...
   flM(T)-Mi NVI2d2. (Such a procedure is optimum under certain conditions). This
...
Feature Weighting and NW—Climbing
   The output of any cognitive demon is
                                 ...
                                 di = 2      d4
                                             '
so that the complete set of weights for all the cognitive demons over all
