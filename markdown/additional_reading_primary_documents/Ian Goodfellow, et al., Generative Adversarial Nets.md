...
arXiv:1406.2661v1 [stat.ML] 10 Jun 2014
                                          ...
                                          articles.
                                              ∗
                                                Jean Pouget-Abadie is visiting Université de Montréal from Ecole Polytechnique.
                                              †
...
pg = pdata . At that point, C(G) achieves the value − log 4.
                          ...
                          ∗                                                             ∗
Proof. For pg = pdata , DG  (x) = 21 , (consider Eq. 2). Hence, by inspecting Eq. 4 at DG (x) = 21 , we
                  1         1
...
      Figure 3: Digits obtained by linearly interpolating between coordinates in z space of the full model.
    ...
    Evaluating p(x)   approximated with       approximated with      approximated with       approximated with
                      AIS                     AIS                    Parzen density          Parzen density
                                                                     ...
                                                                     Any differentiable      Any differentiable
                      Nearly all models       Careful design
                                                                     function is             function is
     Model design     incur extreme           needed to ensure
                                                                     theoretically           theoretically
                      difficulty              multiple properties
                                                                     permitted               permitted
...
[18] Hyvärinen, A. (2005). Estimation of non-normalized statistical models using score matching. J. Machine
   Learning Res., 6.
